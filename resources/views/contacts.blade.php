<section class="container py-5" id="contacts">
    <div class="d-flex align-items-end justify-content-between gap-3 flex-wrap fw-bold">
        <div>
            <p class="muted mb-0 bold">Свяжитесь с нами удобным способом</p>
        </div>
    </div>
    ...
    <div class="text-center mt-4">
        <p class="muted fst-italic">Возможны онлайн-консультации для клиентов из любых городов</p>
    </div>
</section>
